...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x189";
}
}
"  s0  " -> "0x206" [style = solid];
"  s1  " -> "0x208" [style = solid];
"  s2  " -> "0x20a" [style = solid];
"  c3  " -> "0x20b" [style = solid];
"0x20a" -> "0x209";
"0x20a" -> "0x209" [style = dotted];
"0x20b" -> "0x190";
"0x20b" -> "0x209" [style = dashed];
"0x190" -> "0x189";
"0x190" -> "0x189" [style = dotted];
"0x208" -> "0x207";
"0x208" -> "0x207" [style = dotted];
"0x209" -> "0x1c2";
"0x209" -> "0x207" [style = dashed];
"0x1c2" -> "0x189";
"0x1c2" -> "0x189" [style = dotted];
"0x207" -> "0x1e1";
"0x207" -> "0x205" [style = dashed];
"0x206" -> "0x205";
"0x206" -> "0x205" [style = dotted];
"0x1e1" -> "0x189";
"0x1e1" -> "0x189" [style = dotted];
"0x205" -> "0x189";
"0x205" -> "0x189" [style = dotted];
"0x189" [label = "1"];
}
