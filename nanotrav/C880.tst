...
Number of cache insertions: 30608
Number of cache collisions: 2592
Number of cache deletions: 28016
Cache used slots = 18.09% (expected 0.00%)
Soft limit for cache size: 62464
Number of buckets in unique table: 15616
Used buckets in unique table: 20.91% (expected 20.96%)
...
Maximum resident size            =  6256K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1612
Swaps = 0
Input blocks = 0
Output blocks = 8
